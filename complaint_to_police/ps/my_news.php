  ...
  $select="select * from news_tbl where PID='".$_SESSION['PS_ID']."' and ISACTIVE=1";
        ...
        <div class="col-sm-6">
          <div class="blog-box">
            ...
            <div class="blog-caption">
              <h3><a href="javascript:void(0)"><?php echo $row['HEADING']; ?></a></h3>
              
              <p><?php echo $row['DISCRIPTION']; ?></p>
              <ul class="text-center">
                <br>
              <li><i class="fa fa-trash" aria-hidden="true"></i><a href="news_delete.php?id=<?php echo$row['ID']; ?>">Delete</a></li>
