  ...
  <div class="logo-wrapper"> 
    <div class="container">
      <div class="row"> 
        ...
        <div class="colwidth="255" height="55"-sm-12 col-md-10 col-lg-10">
          <nav class="navbar navbar-default pull-right"> 
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
               ...
               <li class="active"><a href="policestation_login.php">Login</a></li>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-10 col-sm-offset-0 col-md-offset-0 col-lg-offset-1">
        ...
        <form class="contact-us-form" action="policestation_loginPro.php" method="POST"
               data-parsley-validate="">
        <div class="form-group col-md-12 input-error">
          <input name="txt_us" class="form-control " placeholder="Enter policestation Email" type="text" required="">
        </div>
        <div class="form-group col-md-12 input-error">
          <input name="txt_pass" class="form-control " placeholder="Enter Password" type="password" required="">
        </div>
