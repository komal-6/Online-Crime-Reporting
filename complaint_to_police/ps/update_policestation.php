            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">News<span class="caret"></span></a>
                 ...
                 <li><a href="view_complent.php">complent</a></li>
...
<div class="inner-page-wrapper aboutus-wrapper">
  <div class="container">
    <div class="title"> <span class="title-border-img"><img height="200px" width="200px" src="../upload/<?php echo$row['PS_PICTURE']; ?>" alt=""></span>
      ...
      <div class="col-sm-12 col-md-12 col-lg-10 col-sm-offset-0 col-md-offset-0 col-lg-offset-1">
        <div class="row">
          <div class="col-sm-12 col-md-12">
            <div class="row">
              ...
              <form class="contact-us-form" action="update_policestationPro.php" method="POST" 
        ...
        <div class="form-group col-md-12 ">
          ...
          <input name="txt_us" class="form-control " placeholder="Enter your Username" type="text" 
            value="<?php echo$row['PS_USERNAME'] ?>" >
        </div>

        <div class="form-group col-md-12 ">
          POLICE STATION NAME
          <input name="txt_psname" class="form-control " placeholder="Enter your Username" type="text" 
            value="<?php echo$row['PS_NAME']; ?>" >
        </div>
        ...
        <div class="form-group col-md-12 input-error">
          Contect Number
           <input name="txt_num" class="form-control " placeholder="Enter your FirstName" type="text" 
            value="<?php echo$row['PS_CONTECT_NUMBER'] ?>" >
        </div>
