          ...
          <nav class="navbar navbar-default pull-right"> 
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
               ...
               <li class="active"><a href="contect_us.php">Contact Us</a></li>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-10 col-sm-offset-0 col-md-offset-0 col-lg-offset-1">
        ...
        <form class="contact-us-form" action="contect_usPro.php" method="POST" 
         enctype="multipart/form-data" data-parsley-validate="">
        	
        <div class="form-group col-md-12 input-error">
        	 Name
          <input name="txt_name" class="form-control required" placeholder="Enter topic" type="text" required="">
        </div>

        <div class="form-group col-md-12 input-error">
          Email Address
          <input name="email" class="form-control required" placeholder="Email" type="email" required="">
        </div>

         <div class="form-group col-md-12 input-error">
           Number
          <input name="number" class="form-control required" placeholder="Enter Contect Number" type="number" required="">
        </div>

        <div class="form-group col-md-12 input-error">
         Message
          <textarea name="msg" rows="10" style="width:100%;" placeholder="Message" class="form-control" required=""></textarea>
        </div>

        <div class="text-md-left col-md-12">
            <button type="submit" class="btn-one" name="btn_sb" style="background-color: #944733;">Send</button>
        </div>
            </div>
          </div>
        </div>
