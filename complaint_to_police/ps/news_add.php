          ...
          <nav class="navbar navbar-default pull-right"> 
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown active"><a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">News<span class="caret"></span></a>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-10 col-sm-offset-0 col-md-offset-0 col-lg-offset-1">
        ...
        <form class="contact-us-form" action="news_addpro.php" method="POST" 
         enctype="multipart/form-data" data-parsley-validate="">
        	<input type="hidden" name="pid" value="<?php echo $_SESSION['PS_ID']; ?>">
        <div class="form-group col-md-12 input-error">
        	 Heading
          <input name="heading" class="form-control required" placeholder="Enter Heading" type="text" required="">
        </div>

        <div class="form-group col-md-12 input-error">
        	News DISCRIPTION
          <textarea name="dis" rows="10" style="width:100%;" placeholder="Description" class="form-control"></textarea>
        </div>

        <div class="form-group col-md-12 input-error">
          Upload Photo/Video
          <input name="fileToUpload" class="form-control" placeholder="Enter topic" type="file" required="">
        </div>
        
        <div class="text-md-left col-md-12">
            <button type="submit" class="btn-one" name="btn_sb" style="background-color: #944733;">Add News</button>
        </div>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
	<?php 
      if (isset($_GET['type'])) {
	 ?>
	 alert("Sorry, only JPG, JPEG, PNG, MP4,MP3,3GP, WMV,WEBM,OGG & GIF files  are allowed");
	 <?php 
	  }
	  ?>
</script> 
