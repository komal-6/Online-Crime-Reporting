...
$id=$_GET['id'];
$select="select * from area_tbl where ID=$id";
              ...
              <div class="col-lg-5">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">State Details</h1>
                  </div>
                  <form class="user" action="area_editPro.php" method="POST">
                    <div class="form-group">
                      <input type="hidden" name="aid" value="<?php echo$row['ID']; ?>">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" value="<?php echo $row['AREA_NAME'] ?>" name="txt_area">
                    </div>
