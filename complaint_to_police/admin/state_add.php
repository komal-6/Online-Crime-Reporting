          ...
          <div class="row">
              ...
              <div class="col-lg-5">
                <div class="p-5">
                  ...
                  <form class="user" action="state_addPro.php" method="POST">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter State Name" name="txt_state">
                    </div>
