...
$id=$_GET['id'];
$select="select * from city_tbl where id=$id and ISACTIVE=1";
              ...
              <div class="col-lg-5">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">City Details</h1>
                  </div>
                  <form class="user" action="city_editPro.php" method="POST">
                    <div class="form-group">
                      <input type="hidden" name="cid" value="<?php echo$row['ID']; ?>">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" value="<?php echo $row['CITY_NAME']; ?>"  name="txt_city">
                    </div>
