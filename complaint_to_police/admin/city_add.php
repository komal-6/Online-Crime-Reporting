          ...
          <div class="row">
              ...
              <div class="col-lg-5">
                <div class="p-5">
                  ...
                  <form class="user" action="city_addPro.php" method="POST">
                    ...
                    <div class="form-group">City Name
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter City Name" name="txt_city">
                    </div>
