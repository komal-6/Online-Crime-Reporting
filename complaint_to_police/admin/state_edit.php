...
$id=$_GET['id'];
$select="select * from state_tbl where ID=$id and ISACTIVE=1";
              ...
              <div class="col-lg-5">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Change State Details</h1>
                  </div>
                  <form class="user" action="state_editPro.php" method="POST">
                    <div class="form-group">
                      <input type="hidden" name="sid" value="<?php echo$row['ID']; ?>">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp"  name="txt_state" value="<?php echo $row['STATE_NAME']; ?>">
                    </div>
