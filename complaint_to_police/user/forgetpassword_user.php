        ...
        <div class="row">
          <div class="col-sm-12 col-md-12">
            <div class="row">
              ...
              <form class="contact-us-form" action="password_chek.php" method="POST"
               data-parsley-validate="">
        <div class="form-group col-md-12 input-error">
          <input name="txt_us" class="form-control " placeholder="Enter Email" type="email" required>
        </div>
            
        <div class="text-md-left col-md-12">
            <button type="submit" name="btn_sb" class="btn-one" style="background-color: #944733;">Next</button>
        </div>
...
<script src="assets/jquery/jquery-3.1.1.min.js"></script> 
 <?php 
   if (isset($_GET['error1'])) {
     # code...
   ?>
  alert('Email Is Wrong Please Enter Valid Email');
   <?php  }?>
