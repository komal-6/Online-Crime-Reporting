          ...
          <nav class="navbar navbar-default pull-right"> 
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
               ...
               <li class="active"><a href="feedback_add.php">Feedback</a></li>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-10 col-sm-offset-0 col-md-offset-0 col-lg-offset-1">
        ...
        <form class="contact-us-form" action="feedbackPro.php" method="POST" 
         enctype="multipart/form-data" data-parsley-validate="">
          
       <input type="hidden" name="uid" value="<?php echo$uid ?>">
        <div class="form-group col-md-12 input-error">
          <textarea name="txt_feedback" rows="10" style="width:100%;" placeholder="Enter Your FeedBack" class="form-control" required=""></textarea>
        </div>
