  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-10 col-sm-offset-0 col-md-offset-0 col-lg-offset-1">
        ...
        <form class="contact-us-form" action="post_addPro.php" method="POST" 
         enctype="multipart/form-data" data-parsley-validate="">
        	<input type="hidden" name="uid" value="<?php echo $_SESSION['id1']; ?>">
        <div class="form-group col-md-12 input-error">
        	 POST NAME
          <input name="txt_name" class="form-control required" placeholder="Enter topic" type="text">
        </div>
        ...
        <div class="text-md-left col-md-12">
            <button type="submit" class="btn-one" name="btn_sb" style="background-color: #944733;">Add Post</button>
        </div>
            </div>
          </div>
        </div>
