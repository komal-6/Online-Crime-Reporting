  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-5 col-md-12">
        <p>
          This websiteis to provide for all persons to complaint against for any crime. This application is to provide such as online complaints,status information of complaint, to reporting for missing the person,kidnapping,details for arrested person,etc. It is also providing of missing and stolen a vehical. It is very better performance for users to complaint for crime at any place. With the help of this software people can submit their complaint in the police station. So all the processes of complaint done very easily. 
        </p>
      </div>
