...
$uid=$_SESSION['id1'];
$select="select * from post_tbl where USER_ID='".$uid."' and  ISACTIVE=1";
        ...
        <div class="blog-box">
          ...
          <div class="blog-caption">
            ...
            <ul class="text-center">
              <br>
            <li><i class="fa fa-trash" aria-hidden="true"></i><a href="post_delete.php?id=<?php echo$row['ID']; ?>">Delete</a></li>
